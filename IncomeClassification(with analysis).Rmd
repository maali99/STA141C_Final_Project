---
title: "STA 141C Final Project (Winter 2020)"
...
### **Introduction**  
**Goal:**   
The goal of the following project is to analyze the Census dataset named “adult.data” to classify the income group, >50K (greater   than $50,000) or <=50K (less than $50,000), of a specific individual. This data will be split into two parts, training and   testing. We intend to implement bag of little bootstraps with the generalized logistic model on the training data set in   hopes to predict the income groups of our test dataset. Based on our dataset we want to implement bag of little bootstraps because then we do not have to worry about the underlying assumptions of distributions. Since the distribution of our dataset is unknown we can turn to bootstrapping to calculate estimates. 
...
* income (Categorical):   
    + Levels: >50K, <=50K 
    + Ex. If someone falls in the >50K group they earn more than 
* age (continuous):
...
Fr now we can conclude that the best method to reduce our estimates, in terms of the Bag of Little Boostraps with Logistic Regression, is the confidence interval approach. This brings our final model to the following:  
Income_LB = 
