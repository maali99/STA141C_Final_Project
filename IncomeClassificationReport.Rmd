...
Fr now we can conclude that the best method to reduce our estimates, in terms of the Bag of Little Boostraps with Logistic Regression, is the confidence interval approach (in the above table under "CI Rate (Upper)" and "CI Rate (Lower)").
